...
<div class="wrap cf">
	...
	<div class="error-entry">
		...
		if ( get_theme_mod( 'mooveit_lite_404_content' ) ) {
			...
			echo __( 'Oops, I screwed up and you discovered my fatal flaw. Well, we\'re not all perfect, but we try.  Can you try this again or maybe visit our <a title="themeIsle" href="'. home_url() .'">Home Page</a> to start fresh.  We\'ll do better next time.', 'mooveit_lite' );
		}
		?>
	</div><!--/.error-entry-->
