							...
							<div class="contact-right">
								<div class="contact-widget">
										...
										if ( get_theme_mod( 'mooveit_lite_contact_sidebar_title' ) ) {
											echo '<div class="contact-widget-title contact-map-title">'. esc_attr( get_theme_mod( 'mooveit_lite_contact_sidebar_map_title' ) ) .'</div>';
										}
								...
								<div class="contact-widget">
									<div class="contact-widget-title">
										...
										if ( get_theme_mod( 'mooveit_lite_contact_sidebar_title' ) != false ) {
											echo esc_attr( get_theme_mod( 'mooveit_lite_contact_sidebar_title' ) );
										}
										?>
									...
									<p>
										...
										if ( get_theme_mod( 'mooveit_lite_contact_sidebar_phone' ) != false ) { ?>
											...
											<span>
												...
												<?php } else { ?>
													<a href="tel:<?php _e( '+1-888-587-8421', 'mooveit_lite' ); ?>" title="<?php _e( '+1 888-587-8421', 'mooveit_lite' ); ?>">
								...
								<div class="contact-widget">
									<div class="contact-socials">
										...
										if ( get_theme_mod( 'mooveit_lite_header_youtube' ) != false ) { ?>
											<a href="<?php echo esc_url( get_theme_mod( 'mooveit_lite_header_youtube' ) ); ?>" title="<?php _e( 'YouTube', 'mooveit_lite' ); ?>" target="_blank">
										...
										if ( get_theme_mod( 'mooveit_lite_header_facebook' ) != false ) { ?>
											<a href="<?php echo esc_url( get_theme_mod( 'mooveit_lite_header_facebook' ) ); ?>" title="<?php _e( 'Facebook', 'mooveit_lite' ); ?>" target="_blank">
												<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="15" viewBox="0 0 32 32">
										...
										if ( get_theme_mod( 'mooveit_lite_header_googleplus' ) != false ) { ?>
											<a href="<?php echo esc_url( get_theme_mod( 'mooveit_lite_header_googleplus' ) ); ?>" title="<?php _e( 'Google+', 'mooveit_lite' ); ?>" target="_blank">
												<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="15" viewBox="0 0 32 32">
										...
										if ( get_theme_mod( 'mooveit_lite_header_twitter' ) != false ) { ?>
											<a href="<?php echo esc_url( 'mooveit_lite_header_twitter' ); ?>" title="<?php _e( 'Twitter', 'mooveit_lite' ); ?>" target="_blank">
