...
<div class="wrap">
	<section class="content">
		...
		<div class="our-clients">
			<?php
			if ( get_theme_mod( 'ti_frontpage_ourclients_logo1' ) ) {

				if ( get_theme_mod( 'ti_frontpage_ourclients_logo1' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo1' ) .'" title="'. __( 'Logo 1', 'mooveit_lite' ) .'" alt="'. __( 'Logo 1', 'mooveit_lite' ) .'" />';
				}
				if ( get_theme_mod( 'ti_frontpage_ourclients_logo2' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo2' ) .'" title="'. __( 'Logo 2', 'mooveit_lite' ) .'" alt="'. __( 'Logo 2', 'mooveit_lite' ) .'" />';
				}
				if ( get_theme_mod( 'ti_frontpage_ourclients_logo3' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo3' ) .'" title="'. __( 'Logo 3', 'mooveit_lite' ) .'" alt="'. __( 'Logo 3', 'mooveit_lite' ) .'" />';
				}
				if ( get_theme_mod( 'ti_frontpage_ourclients_logo4' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo4' ) .'" title="'. __( 'Logo 4', 'mooveit_lite' ) .'" alt="'. __( 'Logo 4', 'mooveit_lite' ) .'" />';
				}
				if ( get_theme_mod( 'ti_frontpage_ourclients_logo5' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo5' ) .'" title="'. __( 'Logo 5', 'mooveit_lite' ) .'" alt="'. __( 'Logo 5', 'mooveit_lite' ) .'" />';
				}
				if ( get_theme_mod( 'ti_frontpage_ourclients_logo6' ) ) {
					echo '<img src="'. get_theme_mod( 'ti_frontpage_ourclients_logo6' ) .'" title="'. __( 'Logo 6', 'mooveit_lite' ) .'" alt="'. __( 'Logo 6', 'mooveit_lite' ) .'" />';
				}
